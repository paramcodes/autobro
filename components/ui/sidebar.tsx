...
function SidebarProvider({
  ...
  // Always toggles the desktop open state so the rail stays usable at
  // every viewport width (no mobile drawer fallback).
...
function Sidebar({
  ...
  // The desktop rail renders at every viewport width — there is no
  // mobile drawer fallback, so the sidebar never disappears on small
  // screens.
  return (
    <div
